...
for itr in range(ITER_NUM):
    ...
    if itr % 100 == 0:
        loss_list.append([loss_D_r[0, 0], loss_D_f[0, 0], loss_G[0, 0]])
        print("{} {} {}".format(loss_D_r[0, 0], loss_D_f[0, 0], loss_G[0, 0]))
...
plt.plot(loss_list[0], label="Discriminator Loss - Real")
plt.plot(loss_list[1], label="Discriminator Loss - Fake")
plt.plot(loss_list[2], label="Generator Loss")
plt.legend(loc="best")
plt.show()